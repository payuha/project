...
#define ACCESS_POINT_NAME  "HS5PEE WIFI"				
...
//*************************************************************
	...
	{
		// DEFAULT CONFIG
		config.ssid = "iMicrotech Airport";
		config.password = "0869244499";
		config.dhcp = true;
		config.IP[0] = 192;config.IP[1] = 168;config.IP[2] = 1;config.IP[3] = 251;
  ...
  server.on ( "/relay.html", []() { Serial.println("relay.html"); server.send ( 200, "text/html", PAGE_RelayPage );   }  );
...
server.on ( "/relay1on", [](){digitalWrite(5, HIGH);server.send ( 200, "text/html", PAGE_RelayPage );});
server.on ( "/relay1off", [](){digitalWrite(5, LOW);server.send ( 200, "text/html", PAGE_RelayPage );}); 

server.on ( "/relay2on", [](){digitalWrite(4, HIGH);server.send ( 200, "text/html", PAGE_RelayPage );});
server.on ( "/relay2off", [](){digitalWrite(4, LOW);server.send ( 200, "text/html", PAGE_RelayPage );}); 
